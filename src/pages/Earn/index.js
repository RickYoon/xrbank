...
import { jugAbi, spotAbi, vatAbi, cdpManagerAbi } from './abis';
...
function Earn() {
  ...
  async function getBalances() {
    ...
    // const ilk = ethers.encodeBytes32String('WEDU'); // 'WXRP'를 bytes32로 인코딩
    ...
    <>
        ...
        <div>   
          <OverBox>
              <SubTemplateBlockVertical>                
                <Wrappertitle>
                    <Title>Earn with XSD</Title>                
                </Wrappertitle>
                <div style={{paddingTop:"20px"}}/>
                  <div className="border border-blue-100 rounded-lg p-6 bg-white">
                  <div className="flex flex-col">
                    <div className="flex items-center">
                      <p className="text-xl font-bold text-neutral-800">XSD Saving</p>
                    </div>
                    <div className="flex flex-col gap-2 w-full pt-5">
                    <div className="grid grid-cols-[1fr_1fr] gap-3">
                        <p className="font-semibold text-left">APR</p>
                        <p className="text-neutral-600 text-right">5.0% + Point</p>
                      </div>
                      <div className="grid grid-cols-[1fr_1fr] gap-3">
                  ...
                  <div className="flex flex-col">
                    <div className="flex flex-col gap-2 w-full pt-5">
                    <hr />
                    <div className="pt-2 grid grid-cols-[1fr_1fr] gap-3">
                        <p className="font-semibold text-left">My Deposited</p>
                        <p className="text-neutral-600 text-right">0 XSD</p>
                      </div>
                      <div className="grid grid-cols-[1fr_1fr] gap-3">
                        <p className="font-semibold text-left">1 Year Profit(Est.)</p>
                        <p className="text-neutral-600 text-right">0 XSD</p>
                      </div>
                    </div>
                  </div>
      ...
      <div>
          <OverBox>
              <SubTemplateBlockVertical>                
                  <div className="border border-blue-100 rounded-lg p-6 bg-white">
                  <p className="font-semibold">Earning with xrBank</p>
                  <div className="flex flex-col">
                  <p className="text-left pt-3">
                    Revenue is generated through the distribution of protocol fees.  <br />
                    Fees from deposits, loans, repayments, and liquidations are shared among participants.
                  </p>
                  </div>
                </div>
